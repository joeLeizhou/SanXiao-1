...
public class DelegateFactoryCustom
{
	static DelegateFactoryCustom factory = new DelegateFactoryCustom();

	public static void Register(Dictionary<Type, DelegateCreate> dict)
	{
