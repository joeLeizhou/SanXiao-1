...
public class LuaInterface_LuaProfilerWrap
{
	...
	static int Clear(IntPtr L)
	{
		try
		{
			...
			LuaInterface.LuaProfiler.Clear();
			return 0;
		}
		catch (Exception e)
		{
	...
	static int GetID(IntPtr L)
	{
		try
		{
			...
			int o = LuaInterface.LuaProfiler.GetID(arg0);
	...
	static int BeginSample(IntPtr L)
	{
		try
		{
			...
			LuaInterface.LuaProfiler.BeginSample(arg0);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int EndSample(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 0);
			LuaInterface.LuaProfiler.EndSample();
			return 0;
		}
		catch (Exception e)
		{
	...
	static int get_list(IntPtr L)
	{
		try
		{
			ToLua.PushSealed(L, LuaInterface.LuaProfiler.list);
			return 1;
		}
		catch (Exception e)
		{
	...
	static int set_list(IntPtr L)
	{
		try
		{
			...
			LuaInterface.LuaProfiler.list = arg0;
			return 0;
		}
		catch (Exception e)
		{
