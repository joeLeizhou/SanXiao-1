...
<root>
  ...
  ├── Editor
  │   ├── Chenjiadian.OrcasIap.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Chenjiadian.OrcasIap.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Chenjiadian.OrcasIap.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Chenjiadian.OrcasIap.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Chenjiadian.OrcasIap`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Orcas IAP Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Chenjiadian.OrcasIap.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Chenjiadian.OrcasIap.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Chenjiadian.OrcasIap.Editor.Tests.asmdef`

  `Tests/Runtime/Chenjiadian.OrcasIap.Tests.asmdef`
...
Use the `Documentations~/Orcas IAP.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
