...
namespace LuaInterface
{
    public static class LuaConst
    {
        ...
        public static string packageShortDir = "Packages/orcas.tolua";
        public static string toluaDir = Path.GetFullPath(packageShortDir) + "/Lua";        //tolua lua文件目录
    ...
    public static string zbsDir = luaResDir + "/mobdebug/";
        ...
        public static bool openLuaCSJson = true;            //是否开启csjson
    }
}