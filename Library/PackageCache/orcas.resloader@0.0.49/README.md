...
<root>
  ...
  ├── Editor
  │   ├── Jykgod.OrcasResources.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Jykgod.OrcasResources.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Jykgod.OrcasResources.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Jykgod.OrcasResources.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Jykgod.OrcasResources`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Orcas Resources Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Jykgod.OrcasResources.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Jykgod.OrcasResources.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Jykgod.OrcasResources.Editor.Tests.asmdef`

  `Tests/Runtime/Jykgod.OrcasResources.Tests.asmdef`
...
Use the `Documentations~/Orcas Resources.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
