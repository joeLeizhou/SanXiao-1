...
namespace OfficeOpenXml.Drawing.Chart
{
    ...
    public sealed class ExcelChartAxis : XmlHelper
    {
        ...
        internal string Id
        {
            get { return GetXmlNodeString("c:axId/@val"); }
        }
        ...
        public eAxisPosition AxisPosition
        {
            ...
            internal set
            {
                SetXmlNodeString(AXIS_POSITION_PATH,
                    value.ToString().ToLower(CultureInfo.InvariantCulture).Substring(0, 1));
            }
        }
        ...
        {
            get { return GetXmlNodeDoubleNull(_crossesAtPath); }
            set
            {
                if (value == null)
                {
        ...
        {
            get { return GetXmlNodeString(_formatPath); }
            set
            {
        ...
        {
            get { return GetXmlNodeBool(_sourceLinkedPath); }
        ...
        public eTickLabelPosition LabelPosition
        {
            ...
            set
            {
                ...
                SetXmlNodeString(_lblPos,
                    lp.Substring(0, 1).ToLower(CultureInfo.InvariantCulture) + lp.Substring(1, lp.Length - 1));
            }
        }
            ...
            get
            {
                if (_font == null)
                {
                    ...
                    _font = new ExcelTextFont(NameSpaceManager, TopNode, "c:txPr/a:p/a:pPr/a:defRPr",
                        new string[] {"pPr", "defRPr", "solidFill", "uFill", "latin", "cs", "r", "rPr", "t"});
                }
        ...
        public bool Deleted
        {
            get { return GetXmlNodeBool("c:delete/@val"); }
        ...
        {
            get { return GetXmlNodeDoubleNull(_minValuePath); }
            set
            {
                if (value == null)
                {
        ...
        {
            get { return GetXmlNodeDoubleNull(_maxValuePath); }
            set
            {
                if (value == null)
                {
        ...
        {
            get { return GetXmlNodeDoubleNull(_logbasePath); }
            set
            {
                if (value == null)
                {
