...
<root>
  ...
  ├── Editor
  │   ├── Jykgod.OrcasData.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Jykgod.OrcasData.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Jykgod.OrcasData.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Jykgod.OrcasData.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Jykgod.OrcasData`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Orcas Data Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Jykgod.OrcasData.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Jykgod.OrcasData.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Jykgod.OrcasData.Editor.Tests.asmdef`

  `Tests/Runtime/Jykgod.OrcasData.Tests.asmdef`
...
Use the `Documentations~/Orcas Data.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
