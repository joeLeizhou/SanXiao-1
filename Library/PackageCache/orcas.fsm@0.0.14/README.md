...
<root>
  ...
  ├── Editor
  │   ├── Jykgod.OrcasFsm.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Jykgod.OrcasFsm.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Jykgod.OrcasFsm.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Jykgod.OrcasFsm.Tests.asmdef
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Jykgod.OrcasFsm`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Orcas Fsm Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Jykgod.OrcasFsm.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Jykgod.OrcasFsm.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Jykgod.OrcasFsm.Editor.Tests.asmdef`

  `Tests/Runtime/Jykgod.OrcasFsm.Tests.asmdef`
...
Use the `Documentations~/Orcas Fsm.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
