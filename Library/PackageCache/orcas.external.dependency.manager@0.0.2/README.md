...
<root>
  ...
  ├── Editor
  │   ├── Chenjiadian.OrcasExternalDependencyManager.Editor.asmdef
  │   └── EditorExample.cs
  ├── Runtime
  │   ├── Chenjiadian.OrcasExternalDependencyManager.asmdef
  │   └── RuntimeExample.cs
  ├── Tests
  │   ├── .tests.json
  │   ├── Editor
  │   │   ├── Chenjiadian.OrcasExternalDependencyManager.Editor.Tests.asmdef
  │   │   └── EditorExampleTest.cs
  │   └── Runtime
  │        ├── Chenjiadian.OrcasExternalDependencyManager.Tests.asmdef
  ...
  │       └── SampleExample.cs
  └── Documentation
       ├── Orcas External Dependency Manager.md
       └── Images
```
...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `Chenjiadian.OrcasExternalDependencyManager`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Orcas External Dependency Manager Manifest** page opens for editing.
...
* Store Editor-specific code under a root editor assembly definition file:
  ...
  `Editor/Chenjiadian.OrcasExternalDependencyManager.Editor.asmdef`

* Store runtime-specific code under a root runtime assembly definition file:

  `Runtime/Chenjiadian.OrcasExternalDependencyManager.asmdef`

* Configure related test assemblies for your editor and runtime scripts:

  `Tests/Editor/Chenjiadian.OrcasExternalDependencyManager.Editor.Tests.asmdef`

  `Tests/Runtime/Chenjiadian.OrcasExternalDependencyManager.Tests.asmdef`
...
Use the `Documentations~/Orcas External Dependency Manager.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
